...
public class TIFFHULMDExtractorPlugin extends AbstractJhoveMDExtractorPlugin{
    ...
    private static List<String> attList = new ArrayList<String>();
		 ...
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeographicType");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogCitation");
		 ...
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogPrimeMeridian");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogAngularUnits");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogAngularUnitSize");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogSemiMajorAxis");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogInvFlattening");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.GeogPrimeMeridianLong");
		 ...
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjLinearUnitSize");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjCenterLong");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjCenterLat");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjCenterEasting");
		 ...
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjFalseOriginNorthing");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjScaleAtCenter");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjScaleAtNatOrigin");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjStdParallel1");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjStdParallel2");
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.GeoKeyDirectory.ProjAzimuthAngle");
		 ...
		 attList.add("TIFFMetadata.IFDs.IFD.Entries.GeoTIFFProperties.VerticalUnits");	
    ...
    {
    	return "JHOVE 1.28.0, TIFF-hul " + getRelease();
    }
