...
public class PDFHULMDExtractorPlugin extends AbstractJhoveMDExtractorPlugin {
    ...
    static {
        ...
        attList.add("PDFMetadata.Documentcatalog.Language");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.HideToolbar");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.HideMenubar");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.HideWindowUI");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.FitWindow");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.CenterWindow");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.DisplayDocTitle");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.NonFullScreenPageMode");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.Direction");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.ViewArea");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.ViewClip");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.PrintArea");
        attList.add("PDFMetadata.Documentcatalog.ViewerPreferences.PageClip");
        ...
        attList.add("PDFMetadata.Fonts.TrueType.Font.Encoding");
        attList.add("PDFMetadata.Fonts.TrueType.Font.ToUnicode");
        attList.add("PDFMetadata.Fonts.Type1.Font.Name");
        attList.add("PDFMetadata.Fonts.Type1.Font.BaseFont");
        attList.add("PDFMetadata.Fonts.Type1.Font.FontSubset");
        attList.add("PDFMetadata.Fonts.Type1.Font.FirstChar");
        attList.add("PDFMetadata.Fonts.Type1.Font.LastChar");
        ...
        attList.add("PDFMetadata.Fonts.Type1.Font.EncodingDictionary.Differences");
        attList.add("PDFMetadata.Fonts.Type0.Font.BaseFont");
        attList.add("PDFMetadata.Fonts.Type0.Font.Encoding");
        attList.add("PDFMetadata.Fonts.Type0.Font.ToUnicode");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.BaseFont");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.CIDSystemInfo.Registry");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.CIDSystemInfo.Supplement");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.FontDescriptor.FontName");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.FontDescriptor.Flags");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.FontDescriptor.FontBBox");
        attList.add("PDFMetadata.Fonts.CIDFontType2.Font.FontDescriptor.FontFile2");
        attList.add("PDFMetadata.Fonts.Type3.Font.Name");
        ...
        attList.add("PDFMetadata.Images.Image.Name");
        attList.add("PDFMetadata.Images.Image.Filter");
        attList.add("PDFMetadata.Images.Image.Interpolate");
        attList.add("PDFMetadata.Images.Image.Decode");
    ...
    public String getAgentName() {
        return "JHOVE 1.34.0, PDF-hul " + getRelease();
    }
    ...
    public String getAttributeByName(String attributeName) {
        if (attributeName != null && attributeName.equalsIgnoreCase("PDFMetadata.Pages.PageCount")) {
            Object object = this.getOriginalAttributeByName("PDFMetadata.Pages");
            if (object == null) {
                return null;
            }
            LinkedList pages = (LinkedList) object;
            return Integer.toString(pages.size());
        } else {
