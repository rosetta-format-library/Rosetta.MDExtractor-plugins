...
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove -Dversion=1.24.2 -Dpackaging=pom -Dfile=./lib/jhove-1.24.2.pom
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove-core -Dversion=1.24.2 -Dpackaging=jar -Dfile=./lib/jhove-core-1.24.2.jar
...
mvn install:install-file -DgroupId=org.openpreservation.jhove.modules -DartifactId=jhove-modules -Dversion=1.24.2 -Dpackaging=pom -Dfile=./lib/jhove-modules-1.24.2.pom
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove-ext-modules -Dversion=1.24.2 -Dpackaging=jar -Dfile=./lib/jhove-ext-modules-1.24.2.jar
