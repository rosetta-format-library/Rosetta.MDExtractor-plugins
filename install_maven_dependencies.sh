...
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove -Dversion=1.26.0 -Dpackaging=pom -Dfile=./lib/jhove-1.26.0.pom
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove-core -Dversion=1.26.0 -Dpackaging=jar -Dfile=./lib/jhove-core-1.26.0.jar
...
mvn install:install-file -DgroupId=org.openpreservation.jhove.modules -DartifactId=jhove-modules -Dversion=1.26.0 -Dpackaging=pom -Dfile=./lib/jhove-modules-1.26.0.pom
mvn install:install-file -DgroupId=org.openpreservation.jhove -DartifactId=jhove-ext-modules -Dversion=1.26.0 -Dpackaging=jar -Dfile=./lib/jhove-ext-modules-1.26.0.jar
